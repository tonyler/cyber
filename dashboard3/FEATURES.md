# Dashboard 3.0 - Feature Overview
...
**Note**: Dashboard 3.0 maintains full backward compatibility with the existing data structure while providing a vastly improved user experience.
